package behavioral.gof.chain_of_responsibility;


import behavioral.gof.chain_of_responsibility.example.processors.BasicTokenProcessor;
import behavioral.gof.chain_of_responsibility.example.processors.OAuthTokenProcessor;
import behavioral.gof.chain_of_responsibility.my_imp.MyConcreteCoRElement1;
import behavioral.gof.chain_of_responsibility.my_imp.MyConcreteCoRElement2;
import behavioral.gof.chain_of_responsibility.example.providers.BasicTokenProvider;
import behavioral.gof.chain_of_responsibility.example.providers.OAuthTokenProvider;
import behavioral.gof.chain_of_responsibility.my_imp.domain.MyConcreteElementToProcess1;
import behavioral.gof.chain_of_responsibility.my_imp.domain.MyConcreteElementToProcess2;
